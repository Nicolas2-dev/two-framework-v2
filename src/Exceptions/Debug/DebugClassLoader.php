...
/**
* Autoloader vérifiant si la classe est réellement définie dans le fichier trouvé.
 *
 * Le ClassLoader encapsulera tous les chargeurs automatiques enregistrés
 * et lèvera une exception si un fichier est trouvé mais le fait
 * ne pas déclarer la classe.
 *
...
class DebugClassLoader
{
    ...
    public function __construct(callable $classLoader)
    {
        ...
        if (!isset(self::$caseCheck)) {
            ...
            if (false === $test || false === $i) {
                // le système de fichiers est sensible à la casse
                self::$caseCheck = 0;
            } elseif (substr($test, -\strlen($file)) === $file) {
                // le système de fichiers n'est pas sensible à la casse et realpath() normalise la casse des caractères
                self::$caseCheck = 1;
            } elseif (false !== stripos(PHP_OS, 'darwin')) {
                // sur MacOSX, HFS+ n'est pas sensible à la casse mais realpath() ne normalise pas la casse des caractères
                self::$caseCheck = 2;
            } else {
                // Les vérifications du cas du système de fichiers ont échoué, il suffit de les désactiver
                self::$caseCheck = 0;
            }
        }
    }
    ...
    /**
     * Obtient le chargeur de classe encapsulé.
     *
    ...
    /**
     * Encapsule tous les chargeurs automatiques.
     */
    public static function enable()
    {
        // Garantit que nous n'atteignons pas https://bugs.php.net/42098
    ...
    public function checkAnnotations(\ReflectionClass $refl, $class)
    {
        ...
        // Ne déclenchez pas de dépréciations pour les classes du même fournisseur
        ...
        // Détecter les annotations sur la classe
        ...
        // Détecter si le parent est annoté
        ...
        // Hériter des annotations @final, @internal et @param pour les méthodes
        ...
        foreach ($refl->getMethods(ReflectionMethod::IS_PUBLIC | ReflectionMethod::IS_PROTECTED) as $method) {
            ...
            // Pour lire les annotations de méthode
    ...
    /**
     * `realpath` sur MacOSX ne normalise pas la casse des caractères.
     */
    private function darwinRealpath($real)
    {
        ...
        if (!isset($dirFiles[$file]) && ') : eval()\'d code' === substr($file, -17)) {
            // Obtenez le nom du fichier à partir de "file_name.php(123) : eval()'d code"
    ...
    /**
     * `class_implements` inclut les interfaces des parents, nous devons donc les exclure manuellement.
     *
     * @param string       $class
