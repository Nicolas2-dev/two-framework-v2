...
/**
 * FlattenException encapsule une erreur ou une exception PHP pour pouvoir la sérialiser.
 *
 * Fondamentalement, cette classe supprime tous les objets de la trace.
 *
