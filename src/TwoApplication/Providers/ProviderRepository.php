...
class ProviderRepository
{
     ...
     * @return void
     */
    public function load(TwoApplication $app, array $providers)
    {
     ...
     * @return void
     */
    protected function registerLoadEvents(TwoApplication $app, $provider, array $events)
    {
     ...
     * @return array
     */
    protected function compileManifest(TwoApplication $app, $providers)
    {
     ...
     */
    public function createProvider(TwoApplication $app, $provider)
    {
